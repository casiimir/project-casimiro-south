export const ENDPOINTS = {
  ...
  get SEARCH_CITIES() {
    return `${this.BASE}autocomplete?activity_offset=0&category_offset=0&city_offset=0&country_offset=0&hotel_offset=0&list_offset=0&pickup_offset=0&venue_offset=0&city_limit=1&venue_limit=0&list_limit=0&hotel_limit=0&country_limit=0&category_limit=0&activity_limit=0&text=`;
  },
